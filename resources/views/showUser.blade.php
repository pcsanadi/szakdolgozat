...
<div class="container">
    <form>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="name" placeholder="Név" value="{{ $user->name }}"/>
            </div>
        </div>
        <div class="form-group row">
            <label for="email" class="col-sm-2 col-form-label">E-mail cím</label>
            <div class="col-sm-10">
                <input type="email" class="form-control" id="email" placeholder="E-mail cím" value="{{ $user->email }}"/>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select id="rlevel" class="form-control">
        ...
        <div class="form-group row">
            ...
            <a href="{{url()->previous()}}" class="btn btn-outline-info">Mégsem</a>
